...
** -LICENSE-END-
*/
#ifndef BMIO_SUBDRIVER_H
#define BMIO_SUBDRIVER_H

#include <linux/list.h>

#include "bmio_driver.h"

struct bmio_subdriver;
typedef struct bmio_subdriver bmio_subdriver_t;

struct bmio_subdriver
{
	const char* name;
	int (*probe)(bmio_driver_t* drv);
	void (*remove)(bmio_driver_t* drv);
